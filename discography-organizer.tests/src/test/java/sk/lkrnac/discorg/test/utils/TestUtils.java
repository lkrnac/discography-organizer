...
public final class TestUtils {
	 ...
	 * should be stored
	 * <p><b><u>
	 * This method expects that is called directly from testing method (not some sub-method)
	 * </u></b><p>
	 * Desired path would be {@link TestUtils#TEST_RESOURCES_PATH}/[test_package]/[test_class]/[test_method]
	...
	public static String getResourcesPathMethod(){
		...
		return getResourcesPathClass(stackTraceElement.getClassName()) + 
	 ...
	 * should be stored
	 * <p>
	 * Desired path would be {@link TestUtils#TEST_RESOURCES_PATH}/[test_package]/
	 * [test_class]
	 * @param fullClassName full class name of unit test class
	 * @return relative path to belonging test resources
	 */
	public static String getResourcesPathClass(String fullClassName){
		StringBuilder b = new StringBuilder();
		b.append(TEST_RESOURCES_PATH).append(fullClassName);
		int lastIndexOf = b.lastIndexOf(".");
		b.replace(lastIndexOf, lastIndexOf + 1, File.separator);
