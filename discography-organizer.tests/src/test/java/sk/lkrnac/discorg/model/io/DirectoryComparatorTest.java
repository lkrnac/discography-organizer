...
public class DirectoryComparatorTest {
	...
	/**
	 * Data provider for test {@link DirectoryComparatorTest#
	 * testCompareDirectories(String, boolean)}
	 * @return parameters for various test runs
	 */
	@DataProvider
	public Object [][] testCompareDirectories(){
		return new Object [][]{
			new Object[] {"success1", true},	
			new Object[] {"success2", true},	
			new Object[] {"fail1", false},	
			new Object[] {"fail2", false},	
			new Object[] {"fail3", false},	
			new Object[] {"fail4", false},	
			new Object[] {"fail5", false},	
			new Object[] {"fail6", false},	
			new Object[] {"fail7", false},	
		};
	}
	
	/**
	 * Unit test for method {@link DirectoryComparator#compareDirectories(
	 * File, File)}
	 * <p>
	 * This test expects specific testing directory and file structure on the hard disk
	 * @param testingDataLocation name of the directory on HDD where are testing data stored 
	 * @param expectedResult expected status for the test
	...
	public void testCompareDirectories(String testingDataLocation, 
			boolean expectedResult) throws DiscographyOrganizerException{
		...
		boolean result = new DirectoryComparator()
			.compareDirectories(fullFile, selectionFile);
	 ...
	 * @param resourcesPath path to the testing directory
	 * @param dirName testing directory name
