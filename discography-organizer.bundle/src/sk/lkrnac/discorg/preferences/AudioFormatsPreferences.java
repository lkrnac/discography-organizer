...
public class AudioFormatsPreferences extends PreferencesHolder{
	...
	void readAudioFormats(){
		...
		warningIfEmpty = Activator.getDefault()
				.getPreferenceStore().getBoolean(AudioFormatsPreferencePage.WARNING_EMPTY_FLAG);
	}
	
	/**
	 * Checks if given extension is lossy audio format 
	 * @param extension string extension to check
